...
<<[The activity for the unit conversion spike](code/UnitConversionSpike/MyActivity.java)

{lang="xml"}
<<[The layout for the unit conversion spike](code/UnitConversionSpike/activity_my.xml)
...
<<(code/UnitDoctor/UnitDoctorTest.java)
...
<<(code/UnitDoctor/MainActivity.java)
